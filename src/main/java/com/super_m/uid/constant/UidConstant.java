package com.super_m.uid.constant;
...
public class UidConstant {
     ...
     * 描述 : 机器ID最大值
     */
    public static final long MAX_WORKER_ID = calaBitMask(WORKER_ID_BITS);

    /**
     * 描述 : 数据中心ID最大值
     */
    public static final long MAX_DATACENTER_ID = calaBitMask(DATACENTER_ID_BITS);
     ...
     */
    public static final long SEQUENCE_MASK = calaBitMask(SEQUENCE_BITS);

    public static final long calaBitMask(long bit) {
        return -1L ^ (-1L << bit);
    }
